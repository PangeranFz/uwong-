...
//=================================================//
const bangkal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `JeffBotTzy`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com`}}}, { quoted: hw })
} 
// Target
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `JeffBotTzy`,"body": `Selamat ${salam} kontol ☺️`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://Wa.me/6285250425386`}}}, { quoted: hw })
} 
//=================================================//
const deploy = (teks) => {
...
"optionName": "VOTE LAH SEMUA"
	...
	{
"optionName": "AYO DONG VOTE LAH MEMEK"
	},
	{
"optionName": "SALAM BROTHER BY FAJAR"
	}
],
...
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/asupantiktok?apikey=e09a73090c`
...
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/aeunicetjoaa?apikey=e09a73090c`
...
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/natajadeh?apikey=e09a73090c`
haikal.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"Ini Kak Jangan Lupa Donasi Ya:)"}, {quoted:m})
break
//=================================================//
case 'kayes':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/kayes?apikey=e09a73090c`
...
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/china?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
case 'viet':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/vietnam?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
case 'thai':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/thailand?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
case 'notnot':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/notnot?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
case 'ryujin':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/ryujin?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
case 'justina':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `hhttps://zenzapis.xyz/randomasupan/justina?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
case 'cecan':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/cecan?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
case 'rose':
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://zenzapis.xyz/randomasupan/rose?apikey=e09a73090c`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
//=================================================//
...
//=================================================//
//=================================================//
case 'translate': case 'terjemahan': case 'ts': {
if (isBan) throw sticBanLu(from)
...
break
//=================================================//
case 'bully': case 'waifu': case 'cuddle': case 'neko': case 'cry': case 'kiss': case 'hug': case 'awoo': case 'lick': case 'megumin': {
if (isBan) throw sticBanLu(from)
...
case 'bdsm': case 'ass': {
if (isBan) throw sticBanLu(from)
let anu = await getBuffer(`https://yx-api.herokuapp.com/api/nsfw/${command}`)
haikal.sendMessage(m.chat, { image: anu, caption: `NihKak` }, { quoted: m})
}
break
//=================================================//
...
case 'shitpost':{
if (isBan) throw sticBanLu(from)
anu = await getBuffer(`https://api.xteam.xyz/randomimage/meme2?APIKEY=96e7a87362202b87`)
haikal.sendMessage(m.chat, { image: anu, caption: `Bilek` }, { quoted: m}).catch((err) => m.reply('Maaf server Xteam sedang down'))
}
break
//=================================================//
...
case 'gelap':{
if (isBan) throw sticBanLu(from)
anu = await getBuffer(`https://api.xteam.xyz/randomimage/dark?APIKEY=96e7a87362202b87`)
haikal.sendMessage(m.chat, { image: anu, caption: `bilek` }, { quoted: m}).catch((err) => m.reply('Maaf server Xteam sedang down'))
}
break
//=================================================//
...
const sangeh = ['5', '10', '15','20', '25','30','35','40','45','50','55','60','65','70','Buru tobat cuy','80','85','90','100']
...
if (!q) return reply (`Contoh : .wangy echa`)
qq = q.toUpperCase()
awikwok = `${qq} ${qq} ${qq} ❤️ ❤️ ❤️ WANGY WANGY WANGY WANGY HU HA HU HA HU HA, aaaah baunya rambut ${qq} wangyy aku mau nyiumin aroma wangynya ${qq} AAAAAAAAH ~ Rambutnya.... aaah rambutnya juga pengen aku elus-elus ~~ AAAAAH ${qq} keluar pertama kali di anime juga manis ❤️ ❤️ ❤️ banget AAAAAAAAH ${qq} AAAAA LUCCUUUUUUUUUUUUUUU............ ${qq} AAAAAAAAAAAAAAAAAAAAGH ❤️ ❤️ ❤️apa ? ${qq} itu gak nyata ? Cuma HALU katamu ? nggak, ngak ngak ngak ngak NGAAAAAAAAK GUA GAK PERCAYA ITU DIA NYATA NGAAAAAAAAAAAAAAAAAK PEDULI BANGSAAAAAT !! GUA GAK PEDULI SAMA KENYATAAN POKOKNYA GAK PEDULI. ❤️ ❤️ ❤️ ${qq} gw ... ${qq} di laptop ngeliatin gw, ${qq} .. kamu percaya sama aku ? aaaaaaaaaaah syukur ${q} aku gak mau merelakan ${qq} aaaaaah ❤️ ❤️ ❤️ YEAAAAAAAAAAAH GUA MASIH PUNYA ${qq} SENDIRI PUN NGGAK SAMA AAAAAAAAAAAAAAH, PENGEN GW KENTOD SAMPE LUMPUH AHHHHHH 🤤🤤`
 reply(awikwok)
break
//=================================================//
case 'cekmati':
...
reply('JUAL WA IMMUNE & SC BOT\n✅WA Immune 20k\n✅Sc Bot 50k\n✅Bot+wa 60k\n✅Jasa upload SC ke Github 3k\n✅Jasa runbot 20k\nLangsung scan jadi ga perlu ribet\nbisa pake sc dari gw dari elu juga bisa cuy\n\nPembayaran:\nGopay/Dana/Pulsa\n\nMau Tanya" silahkan ☺️\nHubungi:\nWa.me/6285250425386')
}
break
//=================================================//
case 'chat': {
...
haikal.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, )
}
break
case '😱': {
if (!isCreator) return
...
if (!isBotAdmins) throw SiGroupadmin(from)
if (!isAdmins) throw sticAdmin(from)
haikal.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, )
}
break
//=================================================//
case '🗿': {
...
if (!isAdmins) throw sticAdmin(from)
if (args[0] === "p") {
if (db.data.chats[m.chat].mute) return reply(`p`)
db.data.chats[m.chat].mute = true
reply(`wk`)
} else if (args[0] === "wk") {
if (!db.data.chats[m.chat].mute) return reply(`wk`)
...
if (isBan) throw sticBanLu(from)
 ...
 break
//=================================================//
 case 'listonline': case 'liston': case 'onlen': {
 if (isBan) throw sticBanLu(from)
...
if (!Number(text)) throw `Example : ${prefix + command} 6285250425386`
...
if (!text) throw `Example : ${prefix + command} ngentot`
...
if (!text) throw `Example : ${prefix + command} Fajar, 5, 8, 2002, Echa, 21, 6, 2004`
...
if (!text) throw `Example : ${prefix + command} Fajar Gans`
...
if (!text) throw `Example : ${prefix + command} Fajar, 5, 8, 2002`
...
if (!text) throw `Example : ${prefix + command} Fajar|Echa`
...
if (!text) throw `Example : ${prefix + command} 5, 8, 2002`
let [tgl, bln, thn] = text.split`,`
...
if (!text) throw `Example : 5, 8, 2002`
let [tgl, bln, thn] = text.split`,`
...
if (!text) throw `Example : ${prefix + command} Fajar, 1, 2002\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (!text) throw `Example : ${prefix + command} Fajar, 5, 8, 2002, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
break
case 'verify':{
if (isRegistered) return reply('Oke Kontol Kamu Sudah Terverifikasi ☺️☺️')
...
if (!text) throw `Example : ${prefix + command} memek\n\nNote : For Detail https://primbon.com/shio.htm`
...
dwhe = await getBuffer(`https://zenzapis.xyz/randomasupan/asupan?apikey=e09a73090c`)
haikal.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `tes` }, { quoted: m })
}
break
//=================================================//
case 'bokep':{
...
dwhe = await getBuffer(`https://raku-web.herokuapp.com/api/bokep?apikey=RakuKeyTod`)
haikal.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `astagfirullah tobat brader` }, { quoted: m })
}
break
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
mutualan??
contact me Wa.me/6285250425386
IG
https://www.instagram.com/haifajarr
TIKTOK
tiktok.com/@fajarjef
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© 𝙅𝙚𝙛𝙛𝘽𝙤𝙩𝙏𝙯𝙮 WE ARE NOT MASTOD`,
"url": "Wa.me/6285250425386"
},
"businessOwnerJid": "6285250425386@s.whatsapp.net",
}
...
┣troli [ Bug Troli ]
┣troli2 [ Bug Troli 2 ]
┣jadibug1 [ Video To Audio ]
┣jadibug2 [ Video To Mp3 ]
┣jadibug3 [ Audio To Vn ]
┣jadibug4 [ Sticker To Gambar ]
┣jadibug5 [ Gambar To Once ] 
┣bugstik [ Contoh : Bugstik 5 ]
┣bugie [ Contoh : Bugie 5 ]
┣buglokas [ Bug Lokasi ]
┣bugtod [ Bug Contact ]
┣bugbokep [ Bug Video ]
┣buginvite [ Bug Chat Pribadi ]
┣bugbctext [ Bug Text Broadcast ]
┣buggc
┗━━⊱
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} asede kontol`
let yts = require("yt-search")
let search = await yts(text)
...
case 'katahariini': {
		let { quotesAnime } = require('./lib/scraper')
                ...
                let buttonMessage = {
                    text: `${result.quotes}\n`,
                    footer: 'Kata-Kata selanjutnya mazzeh',
                    buttons: buttons,
                    headerType: 2
                }
...
case 'confes': case 'menfes': case 'menfess': {
          ...
          if (!pesann)
            m.reply(
              "*Silahkan masukkan :* penerima\npesan kamu\n\nContoh:\nmenfess 6283809215245\nlovyu"
            );
          else m.reply("Menfess kamu telah di kirim!");
          let penerima = args?.join(" ")?.trim()?.split("\n")?.[0]?.trim().replace(/[^0-9]/g, '')+'@s.whatsapp.net';
          let rep = args?.join(" ")?.trim()?.split("\n")?.[0]?.trim() //untuk replace
          let mess = text.replace(rep,"")
          //${haikal.getName(m.sender)}
          pesan = `${mess}`;
          let buttons = [
                    {buttonId: `jf`, buttonText: {displayText: 'Dia Siapa?? 😳'}, type: 1}
                ]
                let buttonMessage = {
                    text : `${mess}`,
                    footer: 'Seseorang Telah Menitipkan Pesan ✉️',
                    buttons: buttons,
                    headerType: 2
                }
          haikal.sendMessage(penerima, buttonMessage, pesan)
            }
        break
case 'jf': {
if (isBan) throw sticBanLu(from)
...
Seseorang Yang Confes ke Kamu Semoga Kamu Peka ❤️
Kiw Kiwwww 🤭🤭🤭
...
case 'wattpad': {
            ...
            haikal.sendImage(m.chat, thumb, capt, m)
            }
            break
case 'fbdl':{
if (isBan) throw sticBanLu(from)

dwhe = await getBuffer(`https://raku-web.herokuapp.com/api/trigger?apikey=RakuKeyTod&url=https://i.ibb.co/cyM9YyH/logoku.jpg`)
haikal.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `tes` }, { quoted: m })
}
break
...
if (isBan) throw sticBanLu(from)
teks = `nih Kak >\\<`
buffer = `https://raku-web.herokuapp.com/api/asupan?apikey=RakuKeyTod`
haikal.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"Success"}, {quoted:m})
break
...
dwhe = await getBuffer(`https://raku-web.herokuapp.com/api/asupan?apikey=RakuKeyTod`)
haikal.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `astagfirullah tobat brader` }, { quoted: m })
}
break
//=================================================//
